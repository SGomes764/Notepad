...
namespace NotePad__
{
    public partial class Form1 : Form
    {
        ...
        private void menuEditarSelecinarTudo_Click(object sender, EventArgs e)
        {
            rbTexto.SelectAll();
        }
        ...
        private void menuAlinhamentoEsqueda_Click(object sender, EventArgs e)
        {
            rbTexto.SelectionAlignment = HorizontalAlignment.Left;
        }

        private void menuAlinhamentoCentro_Click(object sender, EventArgs e)
        {
            rbTexto.SelectionAlignment = HorizontalAlignment.Center;
        }

        private void menuAlinhamentoDireita_Click(object sender, EventArgs e)
        {
